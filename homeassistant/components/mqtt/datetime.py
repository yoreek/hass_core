"""Configure datetime in a device through MQTT topic."""
    ...
    def _message_received(self, msg: ReceiveMessage) -> None:
        ...
        try:
            if payload == self._config[CONF_PAYLOAD_RESET]:
                ...
                datetime_value = dt_util.parse_datetime(payload)
        except ValueError:
            _LOGGER.warning("Payload '%s' is not a Datetime", msg.payload)
            return

        self._attr_native_value = datetime_value
